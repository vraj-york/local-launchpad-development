...
| **Frontend env** | Baked at **build time** from repo root `.env`: `VITE_API_URL`, `VITE_FRONTEND_URL`, `VITE_MODE`, optional `VITE_HUB_*`. | Read from `frontend/.env`: `VITE_API_URL`, etc. |
